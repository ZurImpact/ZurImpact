...
export function VerifyEmailChangePage() {
    ...
    return (
      <AuthFormCard title={t('auth.verifyEmailChange.titleSuccess')}>
        <div className="flex flex-col items-center gap-4 py-4">
          ...
          <p className="text-center text-sm text-muted-foreground">{t('auth.verifyEmailChange.descriptionSuccess')}</p>
  ...
  if (verifyStatus === 'rejected') {
    return (
      <AuthFormCard title={t('auth.verifyEmailChange.titleFailed')}>
        ...
        <p className="mb-4 text-sm text-muted-foreground">{t('auth.verifyEmailChange.resendHintFailed')}</p>
  ...
  return (
    <AuthFormCard title={t('auth.verifyEmailChange.fallbackTitle')}>
      <p className="mb-4 text-sm text-muted-foreground">{t('auth.verifyEmailChange.fallbackDescription')}</p>
