    ...
    <div className="bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-foreground max-w-2xl mx-auto">
              {t("partnerPage.benefitsSubtitle")}
            </p>
          </div>
              ...
              {partnerTypes.map((type, index) => (
                <div key={index} className="flex gap-5 items-start">
                  <div>
                    ...
                    <p className="text-sm text-brand-foreground/70 italic">{t("partnerPage.examples")} {type.examples}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-foreground max-w-2xl mx-auto">
              {t("partnerPage.howItWorksSubtitle")}
            </p>
          </div>
      ...
      <section className="py-20 bg-brand text-brand-foreground">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl mb-6 text-brand-foreground">
            {t("partnerPage.ctaTitle")}
          </h2>
          <p className="text-lg text-brand-foreground/80 mb-8">
            {t("partnerPage.ctaSubtitle")}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => navigate("/contact")}
