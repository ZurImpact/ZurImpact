...
INSERT INTO gps_action_tasks (description, display_name, action_id, gps_x, gps_y, gps_z) VALUES
                                                                                             ('Check in at Bürkliplatz',    'Waypoint 1 – Bürkliplatz',    1, 47.3665, 8.5417, NULL),
                                                                                             ('Check in at Zürichhorn',     'Waypoint 2 – Zürichhorn',     1, 47.3528, 8.5556, NULL),
                                                                                             ('Check in at Seebad Utoquai', 'Waypoint 3 – Seebad Utoquai', 1, 47.3597, 8.5493, NULL),
                                                                                             ('Start at HB Zürich',         'Start – Hauptbahnhof',        4, 47.3782, 8.5403, NULL),
                                                                                             ('Arrive at ZHAW Winterthur',  'End – ZHAW',                  4, 47.4985, 8.7271, NULL);

-- 7. USER_ACTION_MAPPING (run AFTER V8 migration fixes the FK)
INSERT INTO user_action_mapping (user_id, action_id, completion_state, created_on, is_subtask, subaction_id) VALUES
